...
g++ -c "Libraries\soil2\include\SOIL2.c" -std=c++11 -m32 -O3 -o "bin/SOIL2.o"
g++ -c "Libraries\soil2\include\image_DXT.c" -std=c++11 -m32 -O3 -o "bin/image_DXT.o"
g++ -c "Libraries\soil2\include\image_helper.c" -std=c++11 -m32 -O3 -o "bin/image_helper.o"
g++ -c "Libraries\soil2\include\SOIL2.c" -std=c++11 -m32 -O3 -o "bin/SOIL2.o"
